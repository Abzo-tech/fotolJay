...
export class ProductController {
  ...
  async upgradeVip(req: Request, res: Response) {
    try {
      const { id } = req.params;
      const userId = (req as any).user?.id;
      ...
      const product = await productService.upgradeVip(id, userId);
      res.json({
  ...
  async extendDuration(req: Request, res: Response) {
    try {
      const { id } = req.params;
      ...
      const product = await productService.extendDuration(id, userId, extraDays);
      res.json({
